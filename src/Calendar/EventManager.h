...
public:
     ...
     */
    void removeEvent(shared_ptr<Event> event, Event::actionType actionType = Event::actionType::OnlyThis);
    ...
    */
     ...
     * @return string of events that can later be used to import events back
     */
    string exportEvents();
